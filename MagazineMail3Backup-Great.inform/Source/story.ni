"MagazineMail" by Dan Bowen version 3
...
The Library is south of the driveway. 
The post office is east of the driveway.
The UPS depot is east of the post office.

There is a mailbox in the driveway.  The mailbox is an openable container.  The mailbox is fixed in place.

Book 1 - Reading mechanism
...
At the time when the mail-person comes by:
	say "-- You hear a postal truck pull up to the mailbox, then zoom off. --";
...
at the time when the ups-truck leaves:
	say "-- the UPS truck roars away, having left you something --";
	Now all of the things in the UPS truck are in the driveway;
	Now the UPS truck is in the UPS Depot;

Book 4 - The UPS dispatch


A big wooden box, a small box, a medium box, and a flat box are closed openable containers in the UPS depot.
...
A giraffe is in the wooden box.  A hamster cage is in the small box. An accordion is in the medium box.  A set of magic tricks is in the flat box.  They are closed openable containers.
 ...
 The UPS truck is a closed openable enterable vehicle in the UPS depot.
