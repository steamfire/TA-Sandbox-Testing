...
The front Hydrant is nowhere.

When Night begins: 
	say "Now the moon is up."; now the description of the sky is "There is a satellite crawling across the sky...";
	  now the front hydrant is nowhere.


Day begins when Night ends. Day ends when the time of day is 07:55 PM. 
When Day begins: 
	say "The sun is now properly up." ;
	now the front hydrant is in the garden;
